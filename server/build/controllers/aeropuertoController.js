...
class AeropuertoController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const retur = yield database_1.default.query("select * from aeropuerto");
            //console.log(retur);
            res.json(retur);
        });
    }
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query("call insertaAeropuerto('" + req.body.nombre + "', " + req.body.id_ciud + ", '" + req.body.piata + "', '" + req.body.picao + "');");
